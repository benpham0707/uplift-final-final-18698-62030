...
// Hard coded data values as placeholders for form state management
// These represent the comprehensive personal information structure
...
const PersonalInformationWizard: React.FC<Props> = ({ onComplete, onCancel }) => {
...
export default PersonalInformationWizard;