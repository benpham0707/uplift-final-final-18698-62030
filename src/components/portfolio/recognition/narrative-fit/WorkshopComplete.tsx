...
import { CheckCircle2, Copy, FileText, Award, Target, TrendingUp, Zap, Eye, MessageSquare } from 'lucide-react';
          ...
          <div className="grid gap-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Specific percentile or ranking data</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Linked to your academic spine</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Showing measurable impact</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Demonstrates maturity and growth</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Concrete numbers throughout</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">{wordCount} words (perfect range)</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/40 dark:to-emerald-900/40 rounded-xl p-8 text-center border-2 border-green-300 dark:border-green-700 shadow-strong overflow-hidden">
          ...
          <div className="relative space-y-4">
            ...
            <div className="text-6xl font-bold text-green-600 dark:text-green-400">
              {overallScore.toFixed(1)}<span className="text-3xl text-muted-foreground">/10</span>
            </div>
